...
struct cache_entry {
  ...
  char buffer
      [BLOCK_SECTOR_SIZE]; /* Saves the raw data and should be write in sector when cache_entry is evacuated */
};
...
bool inode_create(block_sector_t, off_t size, bool is_dir);
